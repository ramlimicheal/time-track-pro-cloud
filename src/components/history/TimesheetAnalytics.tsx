...
import { analyzeTimesheets } from "@/utils/timesheetAnalytics";
...
export const TimesheetAnalytics = ({ timesheets }: TimesheetAnalyticsProps) => {
  // Memoize analytics calculations to prevent unnecessary re-renders and computations
  const { stats, monthlyTrends, statusDistribution, workPatterns } = useMemo(() => {
    return analyzeTimesheets(timesheets);
  }, [timesheets]);
